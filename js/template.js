    ...
    connectedCallback() {
      this.innerHTML = `
        ...
        <div id="mySideContacts" class="SideContacts hidden">
            <a href="https://www.linkedin.com/in/dosanity/" target="_blank" rel="noopener noreferrer" id="linkedin">
                <div>Linkedin</div>
                <svg style="color: white;" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" fill="currentColor" stroke-width:"0" viewBox="0 0 18.5 13.5">
            ...
            <a href="https://github.com/dosanity" target="_blank" rel="noopener noreferrer" id="github">
                <div>Github</div>
                <svg style="color: white;" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" fill="currentColor" stroke-width:"0" viewBox="0 0 18.5 13.5">
            ...
            <a href="mailto:anthonydo888@gmail.com" id="email">
                <div>Email</div>
                <svg style="color: white;" xmlns="http://www.w3.org/2000/svg" width="45px" height="45px" fill="currentColor" stroke-width:"0" viewBox="0 3 30 26.5">
            ...
            <a href="../assets/pdf/Anthony_ResumeATS.pdf" target="_blank" rel="noopener noreferrer" id="resume">
                <div>Resume</div>
                <svg style="color: white;" xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" fill="currentColor" stroke-width:"0" viewBox="0 0 18.5 14">
