...
built_in:[
/*! `pandas` functions */ "read_csv", "head", "describe", "astype", "loc", "to_datetime", "value_counts", "drop_duplicates", "groupby", "merge", "sort_values", "append",
                          "drop", "DataFrame", "values", "tolist",
/*! `np` functions */ "percentile", "log", "arange", "expand_dims", "prod", "where",
/*! `geopandas` functions */ "GeoDataFrame", "to_crs", "read_file",
/*! `plt` functions */ "subplots", "plot", "scatter", "savefig", "suptitle", "subplot", "set_xticks", "set_yticks", "scatterplot", "tight_layout", "show",
/*! `stats` functions */ "ols", "fit",
/*! `sklearn` functions */ "PCA", "KMeans", "AgglomerativeClustering", "predict", "accuracy_score", "KNeighborsClassifier", "confusion_matrix", "train_test_split",
                          "StandardScaler", "LinearRegression", "r2_score"
/*! `imblearn` functions */ , "SMOTE", "RandomOverSampler", "ClusterCentroids", "SMOTEENN", "BalancedRandomForestClassifier", "EasyEnsembleClassifier",
/*! `svm` functions */ "SVC",
