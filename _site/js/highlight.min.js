...
/*! `np` functions */ "percentile", "log", "arange",
/*! `geopandas` functions */ "GeoDataFrame", "to_crs",
/*! `plt` functions */ "subplots", "plot", "scatter", "figure", "suptitle", "subplot", "set_xticks", "set_yticks", "scatterplot",
/*! `stats` functions */ "ols", "fit",
/*! `sklearn` functions */ "PCA", "KMeans", "AgglomerativeClustering", "predict", "accuracy_score", "KNeighborsClassifier", "confusion_matrix", "train_test_split", "linear_model",
